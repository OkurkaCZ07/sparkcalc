  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <header className="flex justify-between items-center px-5 py-3 border-b" style={{ background:'var(--sc-surface)', borderColor:'var(--sc-border)' }}>
        <Link href="/" className="flex items-center gap-2.5 no-underline">
          ...
          <div>
            ...
            <div className="text-[9px] uppercase tracking-[0.2em]" style={{color:'var(--sc-dim)'}}>AI-Powered Electronics Toolkit</div>
          </div>
        </Link>
      ...
      <footer className="px-5 py-4 text-center text-[11px] border-t" style={{color:'var(--sc-dim)', borderColor:'var(--sc-border)'}}>
        ...
        <p style={{color:'color-mix(in srgb, var(--sc-dim) 60%, transparent)'}}>Affiliate links may earn commission · Powered by Claude AI · <Link href="/privacy" className="hover:underline" style={{color:'var(--sc-dim)'}}>Privacy</Link> · <Link href="/terms" className="hover:underline" style={{color:'var(--sc-dim)'}}>Terms</Link></p>
      </footer>
    </div>
  );
}
