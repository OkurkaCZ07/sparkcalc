  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <footer className="px-5 py-4 text-center text-[11px] text-sc-dim border-t border-sc-border space-y-1">
        ...
        <p className="text-sc-dim/50">Affiliate links may earn commission · Powered by Claude AI · <Link href="/privacy" className="hover:text-sc-accent transition-colors">Privacy</Link> · <Link href="/terms" className="hover:text-sc-accent transition-colors">Terms</Link></p>
      </footer>
    </div>
  );
}
